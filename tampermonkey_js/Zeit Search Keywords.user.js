// ==UserScript==
// @name         Zeit Search Keywords
// @namespace    http://tampermonkey.net/
// @version      2025-07-29
// @description  Search keywords job offers and save all result pages' HTML files
// @author       Parzi & ChatGPT
// @match        https://jobs.zeit.de/
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    let keyword = keywords[index].replace(" ", "%2C");
    ...
    delay(2000)
    window.location.href = `https://jobs.zeit.de/stellenanzeigen?q=${keyword}`;
