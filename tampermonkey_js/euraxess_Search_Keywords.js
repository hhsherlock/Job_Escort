...
(function() {
    ...
    delay(2000)
    window.location.href = `https://euraxess.ec.europa.eu/jobs/search?${encodeURIComponent("f[0]")}=keywords${encodeURIComponent(":")}${keyword}`;
